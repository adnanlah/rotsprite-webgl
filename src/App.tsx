...
function App() {
  ...
  return (
    <div>
      <nav>
        <img src="/girl.png" alt="Pixelart girl"></img>
        <h2>Rotsprite algorithm with JavaScript (Canvas vs WebGL)</h2>
      </nav>
      <main>
        <form>
          <div>
            <label htmlFor="fileInput">
              Choose an image (Maximun size is 512x512):{' '}
            </label>
            <input
              id="fileInput"
              type="file"
      ...
      <footer>
        ...
        <div>
          <a
            href="https://github.com/adnanlah/rotsprite-webgl"
            rel="noreferrer"
            target="_blank"
          >
            <svg
